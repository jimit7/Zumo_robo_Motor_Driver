...
/*! @name PIO0_10 (number 45), J2[11]/P0_10-FC2_SCK-CT32B3_MAT0
  @{ */
#define BOARD_INITPINS_gpio_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_gpio_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_INITPINS_gpio_PIN 10U   /*!<@brief 0U pin index: 10 */
                                      /* @} */
